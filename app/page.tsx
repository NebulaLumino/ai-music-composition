    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-gray-900 text-white flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-16">
        <div className="w-full max-w-2xl">
          <h1 className="text-3xl font-bold mb-2">AI Music Composition</h1>
          <p className="text-gray-400 mb-8">Generate original music compositions with genre, mood, tempo, and instrument preferences.</p>
          <form onSubmit={handleGenerate} className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-1">Instruments</label>
            ...
            <button type="submit" disabled={loading} className="w-full py-3 rounded-lg font-semibold text-white disabled:opacity-50 bg-violet-600">
              {btnLabel}
            </button>
          </form>
          {output && (
